...
class TestTokenizer(unittest.TestCase):
    ...
    def test_parser_comment(self):
        ...
        self.assertEqual(self.tokenizer.statements[0], (1, ['.db', ['0x17']]))
    ...
    def test_parser_string_complex_brackets(self):
    ...
    def test_parser_multi_line_comment(self):
        self.tokenizer.parse(
            '  .db 0x17 /* \ntest\ntest2\ntest 3 4 5 */ .db 0x22')
        self.assertEqual(
            self.tokenizer.statements[0], (1, ['.db', ['0x17']]))
        self.assertEqual(
            self.tokenizer.statements[1], (4, ['.db', ['0x22']]))

    def test_parser_inline_label(self):
        self.tokenizer.parse('dummy: hello world')
        self.assertEqual(self.tokenizer.statements[0], (1, [
                         'dummy:']))
        self.assertEqual(self.tokenizer.statements[1], (1, [
                         'hello', ['world']]))
    ...
    def test_parser_inline_label_no_space(self):
        ...
        self.assertEqual(self.tokenizer.statements[0], (1, [
                         'dummy:']))
        self.assertEqual(
            self.tokenizer.statements[1], (1, ['hello', ['world']]))
